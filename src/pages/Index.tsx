...
const timelineSteps = [
  {
    ...
    icon: "AlertTriangle",
    consequences: [
      "Все расходные операции блокируются: оплата в магазинах, переводы и снятие наличных.",
      "Информация о просрочке передаётся в бюро кредитных историй — банк обязан это делать по закону, даже если просрочка составляет всего один день.",
    ],
  },
  {
    period: "2–60 дней",
    ...
    icon: "PhoneCall",
    consequences: [
      "Банк будет пытаться связаться с вами всеми доступными способами: по телефону, через SMS или Push-уведомления.",
      "В соответствии с условиями договора будут начисляться штрафные санкции, пени и комиссии.",
    ],
  },
  {
    ...
    icon: "FileText",
    consequences: [
      "Возможно вам будет направлено досудебное уведомление.",
      "Банк продолжит попытки связаться с вами любыми доступными способами — чтобы выяснить причины неоплаты и найти решение.",
    ],
  },
];
...
const solutions = [
  ...
  },
  {
    ...
    desc: "Даже частичная оплата покажет вашу готовность решить вопрос и поможет избежать дальнейших последствий.",
  },
  {
    icon: "Handshake",
    title: "Индивидуальное решение",
    desc: "У нас есть программы поддержки: перенос даты платежа, программы рефинансирования или реструктуризация долга.",
  },
];
...
const Index = () => {
  return (
    <div className="min-h-screen bg-[#f4f6f9] font-golos">
      ...
      {/* What is overdue */}
      <section className="bg-[#eef2f8] py-10">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="font-oswald font-semibold text-3xl text-[#2c3e6b] mb-4">
            Что считается просрочкой платежа?
          </h2>
          <p className="text-gray-600 text-base leading-relaxed">
            В кредитном договоре всегда указан срок внесения платежа — конкретный день месяца или платёжный период. Также к договору прилагается график платежей. По картам рассрочки и кредитным картам условия и сроки оплаты также чётко прописаны. При подписании договора клиент принимает на себя обязательство своевременно погашать платежи до указанной даты.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-8 bg-[#eef2f8] rounded-sm p-5 flex gap-3 items-start">
            ...
            <p className="text-[#2c3e6b] text-sm leading-relaxed">
              <strong>Важно:</strong> Не игнорируйте наши сообщения. Свяжитесь с нами самостоятельно — мы обязательно найдём решение, подходящее именно вам.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#f4f6f9] py-14">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-500 mb-10 text-base">
            Ваша ситуация имеет решение. Мы готовы работать с вами, чтобы найти оптимальный выход.
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-10 items-start">
            <div className="flex-1">
              ...
              <p className="text-blue-200 text-base mb-8">
                Мы всегда на связи — выберите удобный для вас способ.
              </p>
